...
def generate_launch_description():
    srs_dir = FindPackageShare("simple_robot_simulator_bringup").find("simple_robot_simulator_bringup")
    teaching_dir = FindPackageShare("teaching_bringup").find("teaching_bringup")

    robot_parameters_path = os.path.join(
        srs_dir, "robots", "ursim10e", "general.json"
    )

    srs_scenario_path = {
        "scenario_path": os.path.join(srs_dir, "scenario", "ur10e"), 
    }

    teaching_scenario_path = {
        "scenario_path": os.path.join(teaching_dir, "scenario", "ur10e"), 
    }
    ...
    rviz_config_file = os.path.join(srs_dir, "config", "bringup_with_ghost.rviz")
    ...
    teaching_tfbc_node = Node(
        ...
        namespace="",
        output="screen",
        parameters=[teaching_scenario_path],
        remappings=[("/tf", "tf"), ("/tf_static", "tf_static")],
        emulate_tty=True,
    )
